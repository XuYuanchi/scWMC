...
for (dropout_index in c(1:3)) {
  for (seed_value in c(1:10)) {
    ...
    data_simulation = readRDS(file = paste0(
      "D:/project/Demo_4/SimulationData_Strategy2/simulation_data/simulation_data_dropout_index_",
    ...
    data_our = readMat(paste0(
        "D:/project/Demo_4/SimulationData_Strategy2/imputation_our_data/our_",
        dropout_index, "_seed_",
        seed_value,
        ".mat"))[[1]]
    data_our = data_our[index,]
    # # load imputed data from ALRA
    data_ALRA = readRDS(paste0(
      "D:/project/Demo_4/SimulationData_Strategy2/ALRA/",
      dropout_index, "_",
      seed_value,
      ".rds"
    ))
    ...
    data_DCA = readRDS(file = paste0(
      "D:/project/Demo_4/SimulationData_Strategy2/DCA/",
      dropout_index, "_",
      seed_value,
      ".rds"
    ))
    ...
    data_drimpute = readRDS(
      paste0(
        "D:/project/Demo_4/SimulationData_Strategy2/imputation_drimpute_data/drimpute_",
        dropout_index, "_",
        seed_value,
        ".rds"
      )
    ...
    data_EnImpute = readRDS(file = paste0("D:/project/Demo_4/SimulationData_Strategy2/EnImpute/", dropout_index, "_", seed_value, ".rds"))[[1]]
    data_EnImpute = data_EnImpute[index,]
    # load the MAGIC imputed data
    data_magic = read.table(
      file = paste0("D:/project/Demo_4/SimulationData_Strategy2/imputation_magic_data/magic_", dropout_index, "_", seed_value, ".csv"),
      header = FALSE,
      sep = ",", row.names = 1
    )
    data_magic = data_magic[index,]
    # load imputed data from PBLR
    data_PBLR <- readMat(paste0("D:/project/Demo_4/SimulationData_Strategy2/PBLR/", dropout_index, "_", seed_value, ".mat"))[[1]]
    data_PBLR = data_PBLR[index,]
    # load imputed data from SAVER
    data_saver = read.table(
      file = paste0(
        "D:/project/Demo_4/SimulationData_Strategy2/imputation_saver_data/saver_",
        dropout_index, "_",
        seed_value,
        ".csv"
      ),
    ...
    data_scimpute = read.table(
      file = paste0(
        "D:/project/Demo_4/SimulationData_Strategy2/imputation_scimpute_data/data_imputation_scimpute_",
        dropout_index, "_",
        seed_value,
        ".csv"
      ),
    ...
    data_scTSSR = read.table(
      file = paste0(
        "D:/project/Demo_4/SimulationData_Strategy2/imputation_scTSSR_data/scTSSR_",
        dropout_index, "_",
        seed_value,
        ".csv"
      ),
    ...
    data_scVI = as.matrix(readRDS(file = paste0(
      "D:/project/Demo_4/SimulationData_Strategy2/scVI/",
      dropout_index, "_",
      seed_value,
      ".rds"
    )))
    ...
    #   file = paste0(
    #     "D:/project/Demo_4/SimulationData_Strategy2/imputation_viper_data/viper_",
    #     dropout_index, "_",
    #     seed_value,
    #     ".csv"
    #   ),
    ...
    error[13] = data_simulation$percentage_zeros
    
    saveRDS(error,
            file = paste0("D:/MyWorkWorld/Imputation/scWMC/simulation_2/error_data/error_zero", dropout_index, "_", seed_value, ".rds"))
...
for (i in c(1:3)) {
  ...
  for (j in c(1:10)) {
    tmp <- readRDS(file = paste0("D:/MyWorkWorld/Imputation/scWMC/simulation_2/error_data/error_zero", i, "_", j, ".rds"))
...
saveRDS(error_list, file = "D:/MyWorkWorld/Imputation/scWMC/simulation_2/data/error_zero_all.rds")
